...
class ExerciseRunner:
    ...
    def run_exercise(self):
        ...
        h3.cmd('sudo ethtool -K h3-eth0 gro off gso off tso off')
        ...
        h6.cmd('sudo ethtool -K h6-eth0 gro off gso off tso off')
        h7.cmd('dhclient h7-eth0')
        h7.cmd('sudo ethtool -K h7-eth0 gro off gso off tso off')
        h8.cmd('dhclient h8-eth0')
        ...
        s2.cmd('sudo ethtool -K s2-eth4 gro off gso off tso off')
        s2.cmd('sudo ethtool -K s2-eth5 gro off gso off tso off')
        s2.cmd('sudo ethtool -K s2-eth6 gro off gso off tso off')
        s2.cmd('sudo ethtool -K s2-eth7 gro off gso off tso off')
        s2.cmd('sudo ethtool -K s2-eth8 gro off gso off tso off')
        s2.cmd('sudo ethtool -K s2-eth9 gro off gso off tso off')
        ...
        h2.cmd('ping -c10 8.8.8.8')
        h2.cmd('ping -c10 sbrc2010.inf.ufrgs.br')
        h3.cmd('ping -c10 8.8.8.8')
        h3.cmd('ping -c10 sbrc2010.inf.ufrgs.br')
        h4.cmd('ping -c10 8.8.8.8')
        h4.cmd('ping -c10 sbrc2010.inf.ufrgs.br')
        h5.cmd('ping -c10 8.8.8.8')
        h5.cmd('ping -c10 sbrc2010.inf.ufrgs.br')
        h6.cmd('ping -c10 8.8.8.8')
        h6.cmd('ping -c10 sbrc2010.inf.ufrgs.br')
        h7.cmd('ping -c10 8.8.8.8')
        h7.cmd('ping -c10 sbrc2010.inf.ufrgs.br')
        h8.cmd('ping -c10 8.8.8.8')
        h8.cmd('ping -c10 sbrc2010.inf.ufrgs.br')


        h1.cmd('cp logs/* results/before/scenario8/logs/')
        h1.cmd('../experiments/scripts/clean/clean_logs.sh')

        h1.cmd('../experiments/scripts/clean/clean_pcaps.sh')
        
        h1.cmd('../experiments/scripts/clean/clean_scenario8.sh')

        
        print '=========================================='
        print ' Scenario8  WGET - 256k'
        print '=========================================='

        h1.cmd('wget http://sbrc2010.inf.ufrgs.br/anais/data/pdf/minicursos.pdf --progress=dot:binary -o results/scenario8/LTP-WGET-256k-h1.txt &')
        h2.cmd('wget http://sbrc2010.inf.ufrgs.br/anais/data/pdf/minicursos.pdf --progress=dot:binary -o results/scenario8/LTP-WGET-256k-h2.txt &')
        h3.cmd('wget http://sbrc2010.inf.ufrgs.br/anais/data/pdf/minicursos.pdf --progress=dot:binary -o results/scenario8/LTP-WGET-256k-h3.txt &')
        h4.cmd('wget http://sbrc2010.inf.ufrgs.br/anais/data/pdf/minicursos.pdf --progress=dot:binary -o results/scenario8/LTP-WGET-256k-h4.txt &')
        h5.cmd('wget http://sbrc2010.inf.ufrgs.br/anais/data/pdf/minicursos.pdf --progress=dot:binary -o results/scenario8/LTP-WGET-256k-h5.txt &')
        h6.cmd('wget http://sbrc2010.inf.ufrgs.br/anais/data/pdf/minicursos.pdf --progress=dot:binary -o results/scenario8/LTP-WGET-256k-h6.txt &')
        h7.cmd('wget http://sbrc2010.inf.ufrgs.br/anais/data/pdf/minicursos.pdf --progress=dot:binary -o results/scenario8/LTP-WGET-256k-h7.txt &')
        h8.cmd('wget http://sbrc2010.inf.ufrgs.br/anais/data/pdf/minicursos.pdf --progress=dot:binary -o results/scenario8/LTP-WGET-256k-h8.txt')

        sleep(5)

        h1.cmd('cp logs/* results/scenario8/LTP/logs/')
        h1.cmd('../experiments/scripts/clean/clean_logs.sh')

        h1.cmd('cp pcaps/* results/scenario8/LTP/pcaps/')
        h1.cmd('../experiments/scripts/clean/clean_pcaps.sh')
