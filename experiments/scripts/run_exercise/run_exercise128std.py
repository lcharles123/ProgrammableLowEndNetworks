...
class ExerciseRunner:
    ...
    def run_exercise(self):
        ...
        h1.cmd('cp logs/* results/before/128k/STD/logs/')
        h1.cmd('../experiments/scripts/clean/clean_logs.sh')

        h1.cmd('cp pcaps/* results/before/128k/STD/pcaps/')
        h1.cmd('../experiments/scripts/clean/clean_pcaps.sh')
        
        ##h1.cmd('../experiments/scripts/clean/clean_128STD.sh')
        """
        print '=========================================='
        print ' Scenario1 UDP - 128k - Payload 128 Bytes '
        print '=========================================='

        h1.cmd('iperf3 -s -i 30 --logfile results/scenario1/128k/STD-UDP-128k-128b.txt &')
        h4.cmd('iperf3 -4 -c %s -t 900 -i 30 -u -b 128k -l 128' % h1.IP())
        h1.cmd('killall iperf3')
        sleep(5)

        h1.cmd('cp logs/* results/scenario1/128k/STD/udp/logs/')
        h1.cmd('../experiments/scripts/clean/clean_logs.sh')

        h1.cmd('cp pcaps/* results/scenario1/128k/STD/udp/pcaps/')
        h1.cmd('../experiments/scripts/clean/clean_pcaps.sh')
        ...
        h1.cmd('iperf3 -s -i 30 --logfile results/scenario1/128k/STD-TCP-128k-128b.txt &')
        h4.cmd('iperf3 -4 -c %s -t 900 -i 30 -b 128k -M 128' % h1.IP())
        h1.cmd('killall iperf3')
        sleep(5)
        
        h1.cmd('cp logs/* results/scenario1/128k/STD/tcp/logs/')
        h1.cmd('../experiments/scripts/clean/clean_logs.sh')

        h1.cmd('cp pcaps/* results/scenario1/128k/STD/tcp/pcaps/')
        h1.cmd('../experiments/scripts/clean/clean_pcaps.sh')
        ...
        h1.cmd('iperf3 -s -i 30 --logfile results/scenario2/128k/STD-UDP-128k-512b.txt &')
        h4.cmd('iperf3 -4 -c %s -t 900 -i 30 -u -b 128k -l 512' % h1.IP())
        h1.cmd('killall iperf3')
        sleep(5)

        h1.cmd('cp logs/* results/scenario2/128k/STD/udp/logs/')
        h1.cmd('../experiments/scripts/clean/clean_logs.sh')

        h1.cmd('cp pcaps/* results/scenario2/128k/STD/udp/pcaps/')
        h1.cmd('../experiments/scripts/clean/clean_pcaps.sh')
        ...
        h1.cmd('iperf3 -s -i 30 --logfile results/scenario2/128k/STD-TCP-128k-512b.txt &')
        h4.cmd('iperf3 -4 -c %s -t 900 -i 30 -b 128k -M 512' % h1.IP())
        h1.cmd('killall iperf3')
        sleep(5)
        
        h1.cmd('cp logs/* results/scenario2/128k/STD/tcp/logs/')
        h1.cmd('../experiments/scripts/clean/clean_logs.sh')

        h1.cmd('cp pcaps/* results/scenario2/128k/STD/tcp/pcaps/')
        h1.cmd('../experiments/scripts/clean/clean_pcaps.sh')
        ...
        h1.cmd('iperf3 -s -i 30 --logfile results/scenario3/128k/STD-UDP-128k-1024b.txt &')
        h4.cmd('iperf3 -4 -c %s -t 900 -i 30 -u -b 128k -l 1024' % h1.IP())
        h1.cmd('killall iperf3')
        sleep(5)

        h1.cmd('cp logs/* results/scenario3/128k/STD/udp/logs/')
        h1.cmd('../experiments/scripts/clean/clean_logs.sh')

        h1.cmd('cp pcaps/* results/scenario3/128k/STD/udp/pcaps/')
        h1.cmd('../experiments/scripts/clean/clean_pcaps.sh')
        ...
        h1.cmd('iperf3 -s -i 30 --logfile results/scenario3/128k/STD-TCP-128k-1024b.txt &')
        h4.cmd('iperf3 -4 -c %s -t 900 -i 30 -b 128k -M 1024' % h1.IP())
        h1.cmd('killall iperf3')
        sleep(5)
        
        h1.cmd('cp logs/* results/scenario3/128k/STD/tcp/logs/')
        h1.cmd('../experiments/scripts/clean/clean_logs.sh')

        h1.cmd('cp pcaps/* results/scenario3/128k/STD/tcp/pcaps/')
        h1.cmd('../experiments/scripts/clean/clean_pcaps.sh')
        ...
        h1.cmd('iperf3 -s -i 30 --logfile results/scenario4/128k/STD-UDP-128k-1448b.txt &')
        h4.cmd('iperf3 -4 -c %s -t 900 -i 30 -u -b 128k' % h1.IP())
        h1.cmd('killall iperf3')
        sleep(5)

        h1.cmd('cp logs/* results/scenario4/128k/STD/udp/logs/')
        h1.cmd('../experiments/scripts/clean/clean_logs.sh')

        h1.cmd('cp pcaps/* results/scenario4/128k/STD/udp/pcaps/')
        h1.cmd('../experiments/scripts/clean/clean_pcaps.sh')
        """
        print '=========================================='
        ...
        h1.cmd('iperf3 -s -i 30 --logfile results/scenario4/128k/STD-TCP-128k-1448b.txt &')
        h4.cmd('iperf3 -4 -c %s -t 900 -i 30 -b 128k' % h1.IP())
        h1.cmd('killall iperf3')
        sleep(5)
        
        h1.cmd('cp logs/* results/scenario4/128k/STD/tcp/logs/')
        h1.cmd('../experiments/scripts/clean/clean_logs.sh')

        h1.cmd('cp pcaps/* results/scenario4/128k/STD/tcp/pcaps/')
        h1.cmd('../experiments/scripts/clean/clean_pcaps.sh')
