...
class ExerciseRunner:
    ...
    def run_exercise(self):
        ...
        h1.cmd('../experiments/scripts/clean/clean_scenario10.sh')
        ...
        h1.cmd('wget http://sbrc2010.inf.ufrgs.br/anais/data/pdf/minicursos.pdf --progress=dot:binary -o results/scenario10/LTP-WGET-256k.txt')
        sleep(5)

        h1.cmd('cp logs/* results/scenario10/LTP/logs/')
        h1.cmd('../experiments/scripts/clean/clean_logs.sh')

        h1.cmd('cp pcaps/* results/scenario10/LTP/pcaps/')
        h1.cmd('../experiments/scripts/clean/clean_pcaps.sh')
