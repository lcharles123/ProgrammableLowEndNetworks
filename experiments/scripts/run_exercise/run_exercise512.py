...
class ExerciseRunner:
    ...
    def run_exercise(self):
        ...
        h1.cmd('cp logs/* results/before/512k/LTP/logs/')
        h1.cmd('./scripts/clean/clean_logs.sh')

        h1.cmd('cp pcaps/* results/before/512k/LTP/pcaps/')
        h1.cmd('./scripts/clean/clean_pcaps.sh')
        
        h1.cmd('./scripts/clean/clean_512LTP.sh')
        ...
        h1.cmd('iperf3 -s -i 30 --logfile results/scenario1/512k/LTP-UDP-512k-128b.txt &')
        h4.cmd('iperf3 -4 -c %s -t 900 -i 30 -u -b 512k -l 128' % h1.IP())
        h1.cmd('killall iperf3')
        sleep(5)

        h1.cmd('cp logs/* results/scenario1/512k/LTP/udp/logs/')
        h1.cmd('./scripts/clean/clean_logs.sh')

        h1.cmd('cp pcaps/* results/scenario1/512k/LTP/udp/pcaps/')
        h1.cmd('./scripts/clean/clean_pcaps.sh')
        ...
        h1.cmd('iperf3 -s -i 30 --logfile results/scenario1/512k/LTP-TCP-512k-128b.txt &')
        h4.cmd('iperf3 -4 -c %s -t 900 -i 30 -b 512k -M 128' % h1.IP())
        h1.cmd('killall iperf3')
        sleep(5)
        
        h1.cmd('cp logs/* results/scenario1/512k/LTP/tcp/logs/')
        h1.cmd('./scripts/clean/clean_logs.sh')

        h1.cmd('cp pcaps/* results/scenario1/512k/LTP/tcp/pcaps/')
        h1.cmd('./scripts/clean/clean_pcaps.sh')
        ...
        h1.cmd('iperf3 -s -i 30 --logfile results/scenario2/512k/LTP-UDP-512k-512b.txt &')
        h4.cmd('iperf3 -4 -c %s -t 900 -i 30 -u -b 512k -l 512' % h1.IP())
        h1.cmd('killall iperf3')
        sleep(5)

        h1.cmd('cp logs/* results/scenario2/512k/LTP/udp/logs/')
        h1.cmd('./scripts/clean/clean_logs.sh')

        h1.cmd('cp pcaps/* results/scenario2/512k/LTP/udp/pcaps/')
        h1.cmd('./scripts/clean/clean_pcaps.sh')
        ...
        h1.cmd('iperf3 -s -i 30 --logfile results/scenario2/512k/LTP-TCP-512k-512b.txt &')
        h4.cmd('iperf3 -4 -c %s -t 900 -i 30 -b 512k -M 512' % h1.IP())
        h1.cmd('killall iperf3')
        sleep(5)
        
        h1.cmd('cp logs/* results/scenario2/512k/LTP/tcp/logs/')
        h1.cmd('./scripts/clean/clean_logs.sh')

        h1.cmd('cp pcaps/* results/scenario2/512k/LTP/tcp/pcaps/')
        h1.cmd('./scripts/clean/clean_pcaps.sh')
        ...
        h1.cmd('iperf3 -s -i 30 --logfile results/scenario3/512k/LTP-UDP-512k-1024b.txt &')
        h4.cmd('iperf3 -4 -c %s -t 900 -i 30 -u -b 512k -l 1024' % h1.IP())
        h1.cmd('killall iperf3')
        sleep(15)

        h1.cmd('cp logs/* results/scenario3/512k/LTP/udp/logs/')
        h1.cmd('./scripts/clean/clean_logs.sh')

        h1.cmd('cp pcaps/* results/scenario3/512k/LTP/udp/pcaps/')
        h1.cmd('./scripts/clean/clean_pcaps.sh')
        """
        print '=========================================='
        ...
        h1.cmd('iperf3 -s -i 30 --logfile results/scenario3/512k/LTP-TCP-512k-1024b.txt &')
        h4.cmd('iperf3 -4 -c %s -t 900 -i 30 -b 512k -M 1024' % h1.IP())
        h1.cmd('killall iperf3')
        sleep(5)
        
        h1.cmd('cp logs/* results/scenario3/512k/LTP/tcp/logs/')
        h1.cmd('./scripts/clean/clean_logs.sh')

        h1.cmd('cp pcaps/* results/scenario3/512k/LTP/tcp/pcaps/')
        h1.cmd('./scripts/clean/clean_pcaps.sh')
        """
        print '=========================================='
        ...
        h1.cmd('iperf3 -s -i 30 --logfile results/scenario4/512k/LTP-UDP-512k-1448b.txt &')
        h4.cmd('iperf3 -4 -c %s -t 900 -i 30 -u -b 512k' % h1.IP())
        h1.cmd('killall iperf3')
        sleep(5)

        h1.cmd('cp logs/* results/scenario4/512k/LTP/udp/logs/')
        h1.cmd('./scripts/clean/clean_logs.sh')

        h1.cmd('cp pcaps/* results/scenario4/512k/LTP/udp/pcaps/')
        h1.cmd('./scripts/clean/clean_pcaps.sh')
        ...
        h1.cmd('iperf3 -s -i 30 --logfile results/scenario4/512k/LTP-TCP-512k-1448b.txt &')
        h4.cmd('iperf3 -4 -c %s -t 900 -i 30 -b 512k' % h1.IP())
        h1.cmd('killall iperf3')
        sleep(5)
        
        h1.cmd('cp logs/* results/scenario4/512k/LTP/tcp/logs/')
        h1.cmd('./scripts/clean/clean_logs.sh')

        h1.cmd('cp pcaps/* results/scenario4/512k/LTP/tcp/pcaps/')
        h1.cmd('./scripts/clean/clean_pcaps.sh')
        """
        print '====================================='
        print '    Ending..................   '
