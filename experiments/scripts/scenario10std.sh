...
cp ../experiments/scripts/topologies/topology10std.json ./topology.json

echo 'Copying run_exercise'
cp ../experiments/scripts/run_exercise/run_exercise10std.py ../utils/run_exercise.py
...
cp topology.json results/scenario10/topologystd.json
