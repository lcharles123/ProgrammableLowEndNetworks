...
class ExerciseRunner:
    ...
    def run_exercise(self):
        ...
        h1.cmd('cp logs/* results/before/256k/LTP/logs/')
        h1.cmd('../experiments/scripts/clean/clean_logs.sh')

        h1.cmd('cp pcaps/* results/before/256k/LTP/pcaps/')
        h1.cmd('../experiments/scripts/clean/clean_pcaps.sh')
        
        #h1.cmd('../experiments/scripts/clean/clean_256LTP.sh')
        ...
        h1.cmd('iperf3 -s -i 30 --logfile results/scenario1/256k/LTP-UDP-256k-128b.txt &')
        h4.cmd('iperf3 -4 -c %s -t 900 -i 30 -u -b 256k -l 128' % h1.IP())
        h1.cmd('killall iperf3')
        sleep(5)

        h1.cmd('cp logs/* results/scenario1/256k/LTP/udp/logs/')
        h1.cmd('../experiments/scripts/clean/clean_logs.sh')

        h1.cmd('cp pcaps/* results/scenario1/256k/LTP/udp/pcaps/')
        h1.cmd('../experiments/scripts/clean/clean_pcaps.sh')
        ...
        h1.cmd('iperf3 -s -i 30 --logfile results/scenario1/256k/LTP-TCP-256k-128b.txt &')
        h4.cmd('iperf3 -4 -c %s -t 900 -i 30 -b 256k -M 128' % h1.IP())
        h1.cmd('killall iperf3')
        sleep(5)
        
        h1.cmd('cp logs/* results/scenario1/256k/LTP/tcp/logs/')
        h1.cmd('../experiments/scripts/clean/clean_logs.sh')

        h1.cmd('cp pcaps/* results/scenario1/256k/LTP/tcp/pcaps/')
        h1.cmd('../experiments/scripts/clean/clean_pcaps.sh')
        ...
        h1.cmd('iperf3 -s -i 30 --logfile results/scenario2/256k/LTP-UDP-256k-512b.txt &')
        h4.cmd('iperf3 -4 -c %s -t 900 -i 30 -u -b 256k -l 512' % h1.IP())
        h1.cmd('killall iperf3')
        sleep(5)

        h1.cmd('cp logs/* results/scenario2/256k/LTP/udp/logs/')
        h1.cmd('../experiments/scripts/clean/clean_logs.sh')

        h1.cmd('cp pcaps/* results/scenario2/256k/LTP/udp/pcaps/')
        h1.cmd('../experiments/scripts/clean/clean_pcaps.sh')
        ...
        h1.cmd('iperf3 -s -i 30 --logfile results/scenario2/256k/LTP-TCP-256k-512b.txt &')
        h4.cmd('iperf3 -4 -c %s -t 900 -i 30 -b 256k -M 512' % h1.IP())
        h1.cmd('killall iperf3')
        sleep(5)
        
        h1.cmd('cp logs/* results/scenario2/256k/LTP/tcp/logs/')
        h1.cmd('../experiments/scripts/clean/clean_logs.sh')

        h1.cmd('cp pcaps/* results/scenario2/256k/LTP/tcp/pcaps/')
        h1.cmd('../experiments/scripts/clean/clean_pcaps.sh')
        ...
        h1.cmd('iperf3 -s -i 30 --logfile results/scenario3/256k/LTP-UDP-256k-1024b.txt &')
        h4.cmd('iperf3 -4 -c %s -t 900 -i 30 -u -b 256k -l 1024' % h1.IP())
        h1.cmd('killall iperf3')
        sleep(5)

        h1.cmd('cp logs/* results/scenario3/256k/LTP/udp/logs/')
        h1.cmd('../experiments/scripts/clean/clean_logs.sh')

        h1.cmd('cp pcaps/* results/scenario3/256k/LTP/udp/pcaps/')
        h1.cmd('../experiments/scripts/clean/clean_pcaps.sh')
        ...
        h1.cmd('iperf3 -s -i 30 --logfile results/scenario3/256k/LTP-TCP-256k-1024b.txt &')
        h4.cmd('iperf3 -4 -c %s -t 900 -i 30 -b 256k -M 1024' % h1.IP())
        h1.cmd('killall iperf3')
        sleep(5)
        
        h1.cmd('cp logs/* results/scenario3/256k/LTP/tcp/logs/')
        h1.cmd('../experiments/scripts/clean/clean_logs.sh')

        h1.cmd('cp pcaps/* results/scenario3/256k/LTP/tcp/pcaps/')
        h1.cmd('../experiments/scripts/clean/clean_pcaps.sh')
        ...
        h1.cmd('iperf3 -s -i 30 --logfile results/scenario4/256k/LTP-UDP-256k-1448b.txt &')
        h4.cmd('iperf3 -4 -c %s -t 900 -i 30 -u -b 256k' % h1.IP())
        h1.cmd('killall iperf3')
        sleep(5)

        h1.cmd('cp logs/* results/scenario4/256k/LTP/udp/logs/')
        h1.cmd('../experiments/scripts/clean/clean_logs.sh')

        h1.cmd('cp pcaps/* results/scenario4/256k/LTP/udp/pcaps/')
        h1.cmd('../experiments/scripts/clean/clean_pcaps.sh')
        """
        print '=========================================='
        ...
        h1.cmd('iperf3 -s -i 30 --logfile results/scenario4/256k/LTP-TCP-256k-1448b.txt &')
        h4.cmd('iperf3 -4 -c %s -t 900 -i 30 -b 256k' % h1.IP())
        h1.cmd('killall iperf3')
        sleep(5)
        
        h1.cmd('cp logs/* results/scenario4/256k/LTP/tcp/logs/')
        h1.cmd('../experiments/scripts/clean/clean_logs.sh')

        h1.cmd('cp pcaps/* results/scenario4/256k/LTP/tcp/pcaps/')
        h1.cmd('../experiments/scripts/clean/clean_pcaps.sh')
