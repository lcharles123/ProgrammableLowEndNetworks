...
class ExerciseRunner:
    ...
    def run_exercise(self):
        ...
        h1.cmd('cp logs/* results/before/scenario9/LTP/logs/')
        h1.cmd('../experiments/scripts/clean/clean_logs.sh')

        h1.cmd('cp pcaps/* results/before/scenario9/LTP/pcaps/')
        h1.cmd('../experiments/scripts/clean/clean_pcaps.sh')
        
        #h1.cmd('../experiments/scripts/clean/clean_scenario9.sh')
        ...
        h1.cmd('iperf3 -s -i 30 --logfile results/scenario9/LTP-UDP-256k-128b.txt &')
        h4.cmd('iperf3 -4 -c %s -t 900 -i 30 -u -b 256k -l 128' % h1.IP())
        h1.cmd('killall iperf3')
        sleep(5)

        h1.cmd('cp logs/* results/scenario9/LTP/udp/logs/')
        h1.cmd('../experiments/scripts/clean/clean_logs.sh')

        h1.cmd('cp pcaps/* results/scenario9/LTP/udp/pcaps/')
        h1.cmd('../experiments/scripts/clean/clean_pcaps.sh')
        """
        print '=========================================='
        ...
        h1.cmd('iperf3 -s -i 30 --logfile results/scenario9/LTP-TCP-256k-128b.txt &')
        h4.cmd('iperf3 -4 -c %s -t 900 -i 30 -b 256k -M 128' % h1.IP())
        h1.cmd('killall iperf3')
        sleep(5)
        
        h1.cmd('cp logs/* results/scenario9/LTP/tcp/logs/')
        h1.cmd('../experiments/scripts/clean/clean_logs.sh')

        h1.cmd('cp pcaps/* results/scenario9/LTP/tcp/pcaps/')
        h1.cmd('../experiments/scripts/clean/clean_pcaps.sh')
